...
public sealed class LocalizationService : ObservableObject, ILocalizationService
{
    private static readonly Dictionary<string, string> English = new(StringComparer.Ordinal)
    {
        ...
        ["AppMenuRecentHeader"] = "Recent",
        ["AppMenuRecentHint"] = "Reopen a document you viewed recently",
        ["RecentClearLabel"] = "Clear recent files",
        ["RecentClearHint"] = "Forget every remembered document",
        ["RecentRemoveEntryTooltip"] = "Remove from recent",
        ...
        ["OverlayCloseExport"] = "Close export",
        ["OverlayCloseRecent"] = "Close recent",
        ...
        ["AppMenuExportLabel"] = "Export",
        ["AppMenuExportHint"] = "Save the current document as PDF or HTML",
        ["AppMenuPrintLabel"] = "Print",
        ["AppMenuPrintHint"] = "Open the system print dialog",
        ...
        ["AppExportHeader"] = "EXPORT",
        ["AppRecentHeader"] = "RECENT",
        ["ExportCancelLabel"] = "Cancel export",
        ["ExportCancelHint"] = "Stop waiting for the current export",
        ["ExportPdfLabel"] = "PDF",
        ["ExportPdfHint"] = "Save a fully rendered PDF document",
        ["ExportHtmlLabel"] = "HTML",
        ["ExportHtmlHint"] = "Save a self-contained HTML document",
        ["ExportPdfDialogTitle"] = "Export PDF",
        ["ExportHtmlDialogTitle"] = "Export HTML",
        ...
        ["TabCopyPath"] = "Copy Path",
        ["TabRevealInExplorer"] = "Reveal in File Explorer",
        ["TabScrollLeft"] = "Scroll tabs left",
        ["TabScrollRight"] = "Scroll tabs right",
        ["TabListAll"] = "All open tabs",
        ["TocToggleHide"] = "Hide table of contents (Ctrl+T)",
        ["TocToggleShow"] = "Show table of contents (Ctrl+T)",
        ["EditorPreviewLabel"] = "PREVIEW",
        ["EditorScrollSyncTooltip"] = "Editor ↔ preview scroll sync",
        ["SplashPreparingDocument"] = "Preparing document...",
        ["SplashPreparingNamedDocument"] = "Preparing {0}...",
    ...
    private static readonly Dictionary<string, string> Russian = new(StringComparer.Ordinal)
    {
        ...
        ["AppMenuRecentHeader"] = "Недавние",
        ["AppMenuRecentHint"] = "Открыть недавно просмотренный документ",
        ["RecentClearLabel"] = "Очистить недавние",
        ["RecentClearHint"] = "Забыть все запомненные документы",
        ["RecentRemoveEntryTooltip"] = "Убрать из недавних",
        ...
        ["OverlayCloseExport"] = "Закрыть экспорт",
        ["OverlayCloseRecent"] = "Закрыть недавние",
        ...
        ["AppMenuExportLabel"] = "Экспорт",
        ["AppMenuExportHint"] = "Сохранить текущий документ как PDF или HTML",
        ["AppMenuPrintLabel"] = "Печать",
        ["AppMenuPrintHint"] = "Открыть системный диалог печати",
        ...
        ["AppExportHeader"] = "ЭКСПОРТ",
        ["AppRecentHeader"] = "НЕДАВНИЕ",
        ["ExportCancelLabel"] = "Отменить экспорт",
        ["ExportCancelHint"] = "Прекратить ожидание текущего экспорта",
        ["ExportPdfLabel"] = "PDF",
        ["ExportPdfHint"] = "Сохранить полностью отрисованный PDF-документ",
        ["ExportHtmlLabel"] = "HTML",
        ["ExportHtmlHint"] = "Сохранить автономный HTML-документ",
        ["ExportPdfDialogTitle"] = "Экспорт PDF",
        ["ExportHtmlDialogTitle"] = "Экспорт HTML",
        ...
        ["TabCopyPath"] = "Копировать путь",
        ["TabRevealInExplorer"] = "Показать в проводнике",
        ["TabScrollLeft"] = "Прокрутить вкладки влево",
        ["TabScrollRight"] = "Прокрутить вкладки вправо",
        ["TabListAll"] = "Все открытые вкладки",
        ["TocToggleHide"] = "Скрыть оглавление (Ctrl+T)",
        ["TocToggleShow"] = "Показать оглавление (Ctrl+T)",
        ["EditorPreviewLabel"] = "ПРЕДПРОСМОТР",
        ["EditorScrollSyncTooltip"] = "Синхронизация прокрутки редактора и предпросмотра",
        ["SplashPreparingDocument"] = "Подготовка документа...",
        ["SplashPreparingNamedDocument"] = "Подготовка «{0}»...",
