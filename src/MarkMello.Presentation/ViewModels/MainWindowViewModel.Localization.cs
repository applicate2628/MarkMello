...
public partial class MainWindowViewModel
{
    ...
    [
        ...
        nameof(ExportFailureNoticeTitle),
        nameof(ExportFailureNoticeGuidance),
        nameof(ExportFailureNoticeDetails),
        nameof(ExportFailureNoticeDiagnosticLabel),
        nameof(ExportFailureNoticeDismissLabel),
